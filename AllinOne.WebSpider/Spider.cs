...
namespace AllinOne.WebSpider
{
    public class Spider
    {
        public string RequestAction(RequestOptions options)
        {
            ...
            request.UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36";//设置User-Agent，伪装成Google Chrome浏览器
